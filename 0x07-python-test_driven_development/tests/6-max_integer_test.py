#!/usr/bin/python3
''' Module for unit testing 6-max_integer script'''
...
class TestMaxInteger(unittest.TestCase):
    ...
    def test_signed_ints_and_floats(self)jj
    ...
    self.assertEqual(max_integer(['d', 'h', 'n', 'z']), 'z')
    self.assertEqual(max_integer(["rnu", 'x']), 'x')
